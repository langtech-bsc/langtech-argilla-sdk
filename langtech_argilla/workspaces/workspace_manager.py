...
class WorkspaceManager:
    ...
    def create_workspace(self, name: str):
        ...
        try:
            ...
            workspace = rg.Workspace(name=name, client=self._client)
    ...
    def get_dataset_manager(self, dataset_name: str):
        return DatasetManager.get_dataset_manager(
            self._client, dataset_name, self._workspace.name
        )

    def create_dataset(self, dataset_name: str, settings: dict):
        return DatasetManager.create_dataset(
            self._client, dataset_name, self._workspace.name, settings
        )
