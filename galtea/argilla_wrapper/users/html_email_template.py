                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%; border-collapse: separate; border: 1px solid #e5e5e5; border-radius: 5px; background-color: #ffffff;">
                    <tr>
                        <td style="padding: 40px;">
                            <h1 style="font-size: 24px; font-weight: bold; margin-top: 0; margin-bottom: 24px;">Hi, $name</h1>
                            ...
                            <p style="margin-bottom: 24px;">We recommend changing your password after your first login. If you have any questions or need assistance, please don't hesitate to reach out.</p>
